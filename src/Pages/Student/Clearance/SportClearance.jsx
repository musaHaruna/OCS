...
const SportClearance = () => {
  ...
  const clearanceType = 'Sports';

  const validReceiptNumbers = ['SPORT123', 'SPORT456', 'SPORT789'];
  ...
  return (
    <div className='clearance-container'>
      <div className='clearance-header'>
        ...
        <p>
          Complete the clearance process by providing your sports receipt
          number.
        </p>
      </div>
        ...
        {!requestSent ? (
          <div className='receipt-section'>
            <label>
              ...
              <input
                type='text'
                placeholder='Enter sports receipt number'
                value={receiptNumber}
