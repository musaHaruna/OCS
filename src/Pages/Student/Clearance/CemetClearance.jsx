...
const CemetClearance = () => {
  ...
  const clearanceType = 'CEMET';

  const validReceiptNumbers = ['CEMET123', 'CEMET456', 'CEMET789'];
  ...
  return (
    <div className='clearance-container'>
      <div className='clearance-header'>
        ...
        <p>
          Complete the clearance process by providing your CEMET receipt number.
        </p>
      </div>
        ...
        {!requestSent ? (
          <div className='receipt-section'>
            <label>
              ...
              <input
                type='text'
                placeholder='Enter CEMET receipt number'
                value={receiptNumber}
