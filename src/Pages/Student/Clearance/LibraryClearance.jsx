...
const LibraryClearance = () => {
  ...
  const clearanceType = 'Library';

  const validReceiptNumbers = ['LIB123', 'LIB456', 'LIB789'];
  ...
  return (
    <div className='clearance-container'>
      <div className='clearance-header'>
        ...
        <p>
          Complete the clearance process by providing your library receipt
          number.
        </p>
      </div>
        ...
        {!requestSent ? (
          <div className='receipt-section'>
            <label>
              ...
              <input
                type='text'
                placeholder='Enter library receipt number'
                value={receiptNumber}
